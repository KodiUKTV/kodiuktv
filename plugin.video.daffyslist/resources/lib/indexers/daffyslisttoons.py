...
class indexer:
    ...
    def root(self):
        try:
            ...
            'action': 'daffyslisttoons.cartoons',
            ...
            'action': 'daffyslisttoons.cartoongenres',
            'image': self.cartoons_image % (random.randint(1,10)),
            'fanart': self.cartoons_fanart
            },
            ...
            {
            'title': 'Anime Genres',
            'action': 'daffyslisttoons.animegenres',
            'image': self.anime_image % (random.randint(1,10)),
            'fanart': self.anime_fanart
            },
            ...
            {
            'title': 'Anime Latest',
            'action': 'daffyslisttoons.animestreams',
    ...
    def cartoons(self, url):
        try:
            ...
            for i in self.list: i.update({'nextaction': 'daffyslisttoons.cartoons', 'nexticon': self.cartoons_image % (random.randint(1,10)), 'nextfanart': self.cartoons_fanart})

            for i in self.list: i.update({'action': 'daffyslisttoons.cartoonstreams'})
    ...
    def cartoongenres(self):
        try:
            ...
            for i in genres: self.list.append({'title': i.title(), 'url': self.cartoongenres_link % i, 'image': self.cartoons_image % (random.randint(1,10)), 'fanart': self.cartoons_fanart, 'action': 'daffyslisttoons.cartoons'})
    ...
    def cartoonstreams(self, url, image, fanart):
        try:
            ...
            for i in self.list: i.update({'action': 'daffyslisttoons.cartoonplay'})
            for i in self.list: i.update({'fanart': self.cartoons_fanart})
    ...
    def anime(self, url):
        try:
            ...
            for i in self.list: i.update({'action': 'daffyslisttoons.animestreams'})
    ...
    def animegenres(self):
        try:
            ...
            for i in genres: self.list.append({'title': i, 'url': self.animegenres_link % i.replace(' ','%20'), 'image': self.anime_image % (random.randint(1,10)), 'fanart': self.anime_fanart, 'action': 'daffyslisttoons.anime'})
    ...
    def animestreams(self, url, image, fanart):
        try:
            ...
            for i in self.list: i.update({'action': 'daffyslisttoons.animeplay'})
            for i in self.list: i.update({'fanart': self.anime_fanart})
